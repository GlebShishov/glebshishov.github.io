...
- <img src="https://glebshishov.fra1.cdn.digitaloceanspaces.com/web/Pepsico/Pepsico-1.webp" class="project-img-parameters img-size-full" alt="Pepsico-1">
    <video muted="muted" loop="loop" autoplay playsinline class="project-img-parameters img-size-full"> <source src="https://glebshishov.fra1.cdn.digitaloceanspaces.com/web/Pepsico/Pepsico-place.mp4"></video>
- <img src="https://glebshishov.fra1.cdn.digitaloceanspaces.com/web/Pepsico/Pepsico-2.webp" class="project-img-parameters img-size-full" alt="Pepsico-2">
    <video muted="muted" loop="loop" autoplay playsinline class="project-img-parameters img-size-full"> <source src="https://glebshishov.fra1.cdn.digitaloceanspaces.com/web/Pepsico/Pepsico-box.mp4"></video>
